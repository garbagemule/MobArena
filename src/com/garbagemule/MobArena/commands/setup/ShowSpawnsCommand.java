...
@CommandInfo(
    name    = "showspawns",
    pattern = "showspawn(point)?s",
    usage   = "/ma showspawns (<arena>)",
    desc    = "show spawnpoints of an arena",
    permission = "mobarena.setup.showspawns"
)
public class ShowSpawnsCommand implements Command
{
    @Override
