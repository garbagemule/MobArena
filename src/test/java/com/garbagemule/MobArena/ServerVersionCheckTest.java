...
public class ServerVersionCheckTest {
    ...
    @Test
    public void oneTen() {
        win("git-Spigot-de459a2-51263e9 (MC: 1.10.2)");
    }

    @Test
    public void oneNine() {
        win("git-Spigot-c6871e2-0cd0397 (MC: 1.9.4)");
    }

    @Test
    public void oneEight() {
        win("git-Spigot-21fe707-e1ebe52 (MC: 1.8.8)");
    }
    ...
    public void oneFourteen() {
        fail("git-Spigot-cafebae-dedbeef (MC: 1.14)");
    }

    @Test
    public void oneThirteen() {
        fail("git-Spigot-f09662d-be557e6 (MC: 1.13.2)");
    }
